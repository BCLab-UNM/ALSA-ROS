...
namespace rqt_rover_gui 
{
  ...
  void RoverGUIPlugin::initPlugin(qt_gui_cpp::PluginContext& context)
  {
   ...
   log_subscriber = nh.subscribe("/swarm_log", 10, &RoverGUIPlugin::logMessageEventHandler, this);
...
void RoverGUIPlugin::logMessageEventHandler(const ros::MessageEvent<std_msgs::String const>& event)
{
